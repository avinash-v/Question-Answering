...
def stripPunc(s):
    ...
    #table = string.maketrans(dict.fromkeys(string.punctuation),)
...
def getAnswer(txt, question):
    ...
    Context_window = 12  # Contextwindow is used to to determine how many words we should pick up at once for cosine_sim  
...
class Recommendation(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            question = None
        response=[]
        response = getAnswer(text,question)
        print(response)
